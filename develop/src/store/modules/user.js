...
export default  {
        ...
        getArticle(context) {
            util.getData(URL + "/find")
                .then(json => {
                    ...
                    console.table(json.state.articles);
                })
        },
    ...
    mutations: {
        ...
        USER_UPDATE(state, new_user) {
            state.isLogin = new_user.isLogin;
            state.name = new_user.name;
            state.icon = new_user.icon;
            state.email = new_user.email;
        },
        USER_RESET(state) {
            state.isLogin = false;
            state.name = '';
